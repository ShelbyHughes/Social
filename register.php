...
<body>
    <div class="wrapper">
        ...
        <form action="register.php" method="POST">
            ...
            <br>
            <?php if(in_array("<span style='color: #14C800;'> Email or password was incorrect </span><br>", $error_array)){ echo "<span style='color: #14C800;'> Email or password was incorrect </span><br>"; } ?>
            <br>
        </form>
        ...
        <form action="register.php" method="POST">
            ...
            <input type="text" name="reg_email" placeholder="Email" value="<?php if(isset($_SESSION['reg_email'])) { echo $_SESSION['reg_email']; } ?>" required>
            <br>
            
            <input type="text" name="reg_email2" placeholder="Confirm Email"value="<?php if(isset($_SESSION['reg_email2'])) { echo $_SESSION['reg_email2']; } ?>"  required>
            <br>
